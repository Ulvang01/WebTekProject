...
const schemes = {
	...
	monochromatic: function (hex, light, steps) {
	...
	shades: function (hex) {
		return [
			hex,
			colors.addLightness(hex, 10),
			colors.addLightness(hex, 20),
			colors.addLightness(hex, 30),
			colors.addLightness(hex, 40),
			colors.addLightness(hex, 50),
			colors.addLightness(hex, 60),
			colors.addLightness(hex, 70),
			colors.addLightness(hex, 80),
			colors.addLightness(hex, 90)
		];
	},
